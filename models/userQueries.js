...
class userModel {
    ...
    async registerUser(email, password, username, age, level) {
        try {
          const query = "INSERT INTO users (email, password, username, age, level) VALUES ($1, $2, $3, $4, $5) RETURNING uuid";
          const result = await this.db.query(query, [email, password, username, age, level]);
